...
import static com.example.user.myapplication.MusicActivity.MusicTest9Activity.emotionM9;

public class MusicTest10Activity extends AppCompatActivity {

    Button musicTest10_1, musicTest10_2,musicTest10_Play, musicTest10_Stop, musicTest10_Pause;

    private MediaPlayer mp;

    public static MediaPlayer emotionM10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_music_test10);

        musicTest10_1 = (Button) findViewById(R.id.musicTest10_1);
        musicTest10_2 = (Button) findViewById(R.id.musicTest10_2);
        musicTest10_Play = (Button) findViewById(R.id.musicTest10_Play);
        musicTest10_Stop = (Button) findViewById(R.id.musicTest10_Stop);
        musicTest10_Pause = (Button) findViewById(R.id.musicTest10_Pause);

        userController = new UserController(getApplicationContext());
        playController = new PlayController(getApplicationContext());

        musicTest10_1.setEnabled(false);
        musicTest10_2.setEnabled(false);

        mp = new MediaPlayer();
        emotionM10 = new MediaPlayer();
        
        RESULT_PATH = FILE_PATH + "/기쁨10.mp3";
        ...
        musicTest10_1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                try {
                    emotionM10.setDataSource(CLICK_PATH + "/기뻐요.mp3");
                } catch (IOException e) {
                    e.printStackTrace();
                }

                playController.IsPlaying(emotionM10);
                ...
                if(childTypeCheck == 2) {
                    ...
                    nHDto = new NHDto(userNHDto.getName().toString(), userNHDto.getAge().toString(), userNHDto.getSex().toString(),
                            "음악",10, "기쁨", "기쁨", musicScore3, null, (lastTime - startTime) / 1000);
                ...
                Intent intent = new Intent(getApplicationContext(), MusicTest11Activity.class);
                startActivity(intent);

            }
        });

        musicTest10_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                try {
                    emotionM10.setDataSource(CLICK_PATH + "/슬퍼요.mp3");
                } catch (IOException e) {
                    e.printStackTrace();
                }
                ...
                if(childTypeCheck == 2) {
                    ...
                    nHDto = new NHDto(userNHDto.getName().toString(), userNHDto.getAge().toString(), userNHDto.getSex().toString(),
                            "음악",10, "기쁨", "슬픔", musicScore3, "기쁨", (lastTime - startTime) / 1000);
        ...
        musicTest10_Play.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                musicTest10_1.setEnabled(true);
                musicTest10_2.setEnabled(true);

            }
        });

        musicTest10_Stop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        musicTest10_Pause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
