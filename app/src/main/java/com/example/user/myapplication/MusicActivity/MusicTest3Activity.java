...
import static com.example.user.myapplication.MusicActivity.MusicTest2Activity.emotionM2;

public class MusicTest3Activity extends AppCompatActivity {

    Button musicTest3_1, musicTest3_2,musicTest3_Play, musicTest3_Stop, musicTest3_Pause;

    private MediaPlayer mp;

    public static MediaPlayer emotionM3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_music_test3);

        musicTest3_1 = (Button) findViewById(R.id.musicTest3_1);
        musicTest3_2 = (Button) findViewById(R.id.musicTest3_2);
        musicTest3_Play = (Button) findViewById(R.id.musicTest3_Play);
        musicTest3_Stop = (Button) findViewById(R.id.musicTest3_Stop);
        musicTest3_Pause = (Button) findViewById(R.id.musicTest3_Pause);

        userController = new UserController(getApplicationContext());
        playController = new PlayController(getApplicationContext());

        musicTest3_1.setEnabled(false);
        musicTest3_2.setEnabled(false);

        mp = new MediaPlayer();
        emotionM3 = new MediaPlayer();
        
        RESULT_PATH = FILE_PATH + "/기쁨3.mp3";
        ...
        musicTest3_1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                try {
                    emotionM3.setDataSource(CLICK_PATH + "/기뻐요.mp3");
                } catch (IOException e) {
                    e.printStackTrace();
                }

                playController.IsPlaying(emotionM3);
                ...
                if(childTypeCheck == 2) {
                    ...
                    nHDto = new NHDto(userNHDto.getName().toString(), userNHDto.getAge().toString(), userNHDto.getSex().toString(),
                            "음악",3, "기쁨", "기쁨", musicScore3, null, (lastTime - startTime) / 1000);
                ...
                Intent intent = new Intent(getApplicationContext(), MusicTest4Activity.class);
                startActivity(intent);

            }
        });

        musicTest3_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                try {
                    emotionM3.setDataSource(CLICK_PATH + "/슬퍼요.mp3");
                } catch (IOException e) {
                    e.printStackTrace();
                }
                ...
                if(childTypeCheck == 2) {
                    ...
                    nHDto = new NHDto(userNHDto.getName().toString(), userNHDto.getAge().toString(), userNHDto.getSex().toString(),
                            "음악",3, "기쁨", "슬픔", musicScore3, "기쁨", (lastTime - startTime) / 1000);
        ...
        musicTest3_Play.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                musicTest3_1.setEnabled(true);
                musicTest3_2.setEnabled(true);

            }
        });

        musicTest3_Stop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        musicTest3_Pause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
