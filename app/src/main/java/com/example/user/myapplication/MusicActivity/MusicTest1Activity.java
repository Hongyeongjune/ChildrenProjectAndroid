...
public class MusicTest1Activity extends AppCompatActivity {

    Button musicTest1_1, musicTest1_2,musicTest1_Play, musicTest1_Stop, musicTest1_Pause;

    private MediaPlayer mp;

    public static MediaPlayer emotionM1;
    ...
    public static Long musicScore1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_music_test1);

        musicTest1_1 = (Button) findViewById(R.id.musicTest1_1);
        musicTest1_2 = (Button) findViewById(R.id.musicTest1_2);
        musicTest1_Play = (Button) findViewById(R.id.musicTest1_Play);
        musicTest1_Stop = (Button) findViewById(R.id.musicTest1_Stop);
        musicTest1_Pause = (Button) findViewById(R.id.musicTest1_Pause);

        userController = new UserController(getApplicationContext());
        playController = new PlayController(getApplicationContext());

        musicTest1_1.setEnabled(false);
        musicTest1_2.setEnabled(false);

        mp = new MediaPlayer();
        emotionM1 = new MediaPlayer();

        RESULT_PATH = FILE_PATH + "/기쁨1.mp3";
        ...
        musicTest1_1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                try {
                    emotionM1.setDataSource(CLICK_PATH + "/기뻐요.mp3");
                } catch (IOException e) {
                    e.printStackTrace();
                }

                playController.IsPlaying(emotionM1);
                ...
                if (childTypeCheck == 2) {
                    ...
                    nHDto = new NHDto(userNHDto.getName().toString(), userNHDto.getAge().toString(), userNHDto.getSex().toString(),
                                "음악", 1, "기쁨", "기쁨", musicScore1, null, (lastTime - startTime) / 1000);
                ...
                Intent intent = new Intent(getApplicationContext(), MusicTest2Activity.class);
                startActivity(intent);

            }
        });

        musicTest1_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                try {
                    emotionM1.setDataSource(CLICK_PATH + "/슬퍼요.mp3");
                } catch (IOException e) {
                    e.printStackTrace();
                }
                ...
                if (childTypeCheck == 2) {
                    ...
                    nHDto = new NHDto(userNHDto.getName().toString(), userNHDto.getAge().toString(), userNHDto.getSex().toString(),
                                "음악", 1, "기쁨", "슬픔", musicScore1, "기쁨", (lastTime - startTime) / 1000);
        ...
        musicTest1_Play.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                musicTest1_1.setEnabled(true);
                musicTest1_2.setEnabled(true);

            }
        });

        musicTest1_Stop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        musicTest1_Pause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
